...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('accounts.dashboard')); ?>" style="color:#38bdf8"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="modern-card">
                    ...
                    <h3>Total Orders</h3>
                    <h2><?php echo e($posting->count()); ?></h2>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="modern-card">
                    ...
                    <h2><?php echo e($posting->where('status', '0')->count()); ?></h2>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="modern-card">
                    ...
                    <h3>Processing</h3>
                    <h2><?php echo e($posting->where('status', '2')->count()); ?></h2>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="modern-card">
                    ...
                    <h3>Completed</h3>
                    <h2><?php echo e($posting->where('status', '5')->count()); ?></h2>
                </div>
            </div>
