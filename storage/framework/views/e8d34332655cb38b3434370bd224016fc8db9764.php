...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', '"Sales Automation Process"'); ?></title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <!-- top nav part================================ -->
        <?php echo $__env->make('layouts.includes.topnav_distributor', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <!-- top nav part================================ -->
    ...
    <!-- jQuery 3 -->
    <script src="<?php echo e(asset('resources/assets/dms/bower_components/jquery/dist/jquery.min.js')); ?>"></script>
    <!-- Bootstrap 3.3.7 -->
    <script src="<?php echo e(asset('resources/assets/dms/bower_components/bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
    <!-- Select2 -->
    <script src="<?php echo e(asset('resources/assets/dms/bower_components/select2/dist/js/select2.full.min.js')); ?>"></script>
    <!-- DataTables -->
    <script src="<?php echo e(asset('resources/assets/dms/bower_components/datatables.net/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('resources/assets/dms/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js')); ?>">
    </script>
    <!-- date-range-picker -->
    <script
        src="<?php echo e(asset('resources/assets/dms/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')); ?>">
    </script>
    <!-- SlimScroll -->
    <script src="<?php echo e(asset('resources/assets/dms/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
    <!-- FastClick -->
