<?php $__env->startSection('title'); ?>
    <?php echo e("Sales Automation Process :: Login"); ?>
...
<div class="login-box">
  <div class="login-logo">
    <!-- <?php if(@$_SESSION["logo"] ): ?>
      <img src="<?php echo e(asset( 'storage/app/d/nokia/' . $_SESSION['logo'])); ?>" class="responsive no-repeat" alt="logo">
    <?php else: ?>
      <img src="<?php echo e(asset('resources/assets/dms/dist/img/logo.png')); ?>" class="responsive no-repeat" alt="logo">
    <?php endif; ?> -->
    <img src="<?php echo e(asset('resources/assets/dms/dist/img/logo.png')); ?>" class="responsive no-repeat" alt="logo">
  ...
  <div class="login-box-body">
    ...
    <form method="post" action="<?php echo e(route('auth.login.store')); ?>">
        ...
        <div class="form-group has-feedback <?php echo e($errors->has('email') ? 'has-error' : ''); ?>">
          ...
          <input class="form-control" name="email" id="exampleInputEmail1" type="text" placeholder="Enter email" value="<?php echo e(old('email')); ?>">
...
<?php echo $__env->make('layouts.extra', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>