<?php $__env->startSection('title'); ?>
  <?php echo e("Sales Automation Process :: Dashboard"); ?>
...
<!-- content part================================ -->
  ...
  <div class="content-wrapper">
    ...
    <!-- bc part================================ -->
      <!-- <?php echo $__env->make('admin.bc.bc', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
    <!-- bc part================================ -->
...
<div class="mira-wrap">
    <a href="<?php echo e(route('admin.mira')); ?>" style="width: 100%; text-decoration: none, display: inline-block;">
        <button
...
<div class="admin-action-row" style="margin-top:8px; margin-left:10px;">
    <!-- Data Sync (styled) -->
    <a class="action-btn action-sync" href="<?php echo e(route('admin.dataSink')); ?>" id="btnDataSync">
    ...
    <a class="action-btn action-refresh" href="<?php echo e(route('admin.dashboard.cache')); ?>" id="btnRefreshDashboard">
  ...
  <div class="stats-row" style="margin-left:4px; margin-right:4px;">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['totalPrimarySale']); ?>"><?php echo e($data['totalPrimarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-yellow">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['monthlyPrimarySale']); ?>"><?php echo e($data['monthlyPrimarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-green">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['todayPrimarySale']); ?>"><?php echo e($data['todayPrimarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-aqua">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['totalSecondarySale']); ?>"><?php echo e($data['totalSecondarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-yellow">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['monthlySecondarySale']); ?>"><?php echo e($data['monthlySecondarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-green">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['todaySecondarySale']); ?>"><?php echo e($data['todaySecondarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-aqua">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['totalTertiarySale']); ?>"><?php echo e($data['totalTertiarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-yellow">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['monthlyTertiarySale']); ?>"><?php echo e($data['monthlyTertiarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="stat-card stat-green">
      ...
      <div class="stat-content">
        ...
        <div class="stat-number">
          <span class="animated-count">
            <span class="countup" data-target="<?php echo e($data['todayTertiarySale']); ?>"><?php echo e($data['todayTertiarySale']); ?></span>
          </span>
        </div>
      </div>
    </div>
...
<script>
  ...
  const dayInMonthLabels = [
    <?php $__currentLoopData = $dayinmonthchartdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(sprintf('%02d-%02d', $value['day'], $value['month'])); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
  const dayInMonthValues = [
    <?php $__currentLoopData = $dayinmonthchartdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php echo e($value['sale']); ?>,
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];

  const monthInYearLabels = [
    <?php $__currentLoopData = $monthinyearchartdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(date('M', mktime(0,0,0,$value['month'],1,$value['year']))); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
  ...
  const todayBrandLabels = [
    <?php $__currentLoopData = $todaybrandwisesalechart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(addslashes($value['name'])); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
  ...
  const monthlyBrandLabels = [
    <?php $__currentLoopData = $monthlybrandwisesalechart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(addslashes($value['name'])); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
  ...
  const topProductLabels = [
    <?php $__currentLoopData = $monthlytopproductchart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(addslashes($value->product)); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
  ...
  const topRetailerLabels = [
    <?php $__currentLoopData = $monthlytopretailerchart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(addslashes($value->user)); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
  ...
  const topSecondaryLabels = [
    <?php $__currentLoopData = $monthlytopproductsalechart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(addslashes($value->product)); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
  ...
  const topDistributorLabels = [
    <?php $__currentLoopData = $monthlytopdistributorchart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      "<?php echo e(addslashes($value->user)); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ];
