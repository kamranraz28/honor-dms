...
<head>
    ...
    <?php echo $__env->yieldPushContent('customheader'); ?>
    ...
    <script>
        $(function () {
            ...
            $('#retailer_search').on('input', function () {
                ...
                $.get("<?php echo e(route('retailers.search')); ?>", { q: query }, function (data) {
...
$(function () {
    ...
    $('#distributor_search').on('input', function () {
        ...
        $.get("<?php echo e(route('distributors.search')); ?>", { q: query }, function (data) {
...
$(function () {
    ...
    $('#category_search').on('input', function () {
        ...
        $.get("<?php echo e(route('category.search')); ?>", { q: query }, function (data) {
...
$(function () {
    ...
    $('#brand_search').on('input', function () {
        ...
        $.get("<?php echo e(route('brands.search')); ?>", { q: query }, function (data) {
...
$(function () {
    ...
    $('#product_search').on('input', function () {
        ...
        $.get("<?php echo e(route('products.search')); ?>", { q: query }, function (data) {
...
$(function () {
    ...
    bindAjaxSearch(
        ...
        'division_list',
        'division_id',
        "<?php echo e(route('divisions.search')); ?>",
        () => ({})
    );
    ...
    bindAjaxSearch(
        ...
        'district_list',
        'district_id',
        "<?php echo e(route('districts.search')); ?>",
        () => ({
    ...
    bindAjaxSearch(
        ...
        'upazila_list',
        'upazila_id',
        "<?php echo e(route('upazilas.search')); ?>",
        () => ({
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <!-- top nav part================================ -->
        <?php echo $__env->make('layouts.includes.topnav_admin', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <!-- top nav part================================ -->
