                    ...
                    <form action="{{ route('oraderposting.store') }}" method="POST">
                        ...
                        <table class="table-bordered table">
                            <thead>
                                ...
                                {{--  <tr>
                                        <th colspan="4">TSO: @dump($orader->user)</th>
                                        <th colspan="3">user_id: {{ $orader->user_id }}</th>
                                    </tr>  --}}
                                <tr>
                                <th colspan="4">Dist Address: {{ @$orader->users->address ?? '-' }}</th>
                                    <th colspan="3">Status:
                        ...
                        @if (!$orader->status)
                            <button type="submit" class="btn btn-success btn-lg">Orader Posting</button>
                        @endif
                    </form>
                </div>
                        ...
                        <table class="table-bordered table">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="2">Created at: {{ $orader->created_at }} </th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($postings as $value)
                                    @for ($count = 0; $count < count($value->OrderspostingDetails); $count++)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td> {{$value->OrderspostingDetails[$count]->product->model}}
                                            </td>
