...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('topmanagement.dosReportStore') }} " autocomplete="off" enctype="multipart/form-data">
...
<div class="col-sm-123">
    <div class="input-group">
        <label class="checkbox-inline" style="display: none;">
            <input type="checkbox" checked value="all_report" name="all_report" style="display: none;">
            All
        </label>
    </div>
</div>
