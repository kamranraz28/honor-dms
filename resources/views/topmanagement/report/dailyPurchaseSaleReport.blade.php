...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('topmanagement.dailyPurchaseSaleReport.store') }} " autocomplete="off" enctype="multipart/form-data">
...
<!-- body part -->
  ...
  <form action="{{route('topmanagement.purchase.delete',$element->id)}}" method="post">
...
<form action="{{route('topmanagement.purchase.update')}}" method="post">
...
<!-- body part -->
  ...
  <form action="{{route('topmanagement.sale.delete',$element->id)}}" method="post">
   <p class="text-info">Do You Want To Delete This Data ?</p>
   <br>
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <input name="_method" type="hidden" value="delete">
...
<form action="{{route('topmanagement.sale.update')}}" method="post">
  <p class="text-info">Do You Want To Update This Data ?</p>
   <br>
