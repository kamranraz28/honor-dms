...
<div class="box-body">
  <div style="display: flex; justify-content: center; align-items: center; height: 20vh; margin: 0; background-color: #f0f0f0;">
        <a href="{{ route('admin.mira') }}" target="_blank" style="width: 100%; text-decoration: none; display: inline-block;">
            <button
