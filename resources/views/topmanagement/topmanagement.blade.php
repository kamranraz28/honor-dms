...
<form action="{{route('topmanagement.topmanagement.update')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
...
<form action="{{route('topmanagement.topmanagement.updatePassword')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
