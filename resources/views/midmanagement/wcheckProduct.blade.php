...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('midmanagement.wcheckProduct.store') }} " autocomplete="off" enctype="multipart/form-data">
...
@endphp
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
<p style="text-align: center;font-size: 12px;font-weight: bold;color: black;">Retailer Daily Report By {{$ssdata['imei']}}</p>
...
<form action="{{route('midmanagement.wcheckProduct.repalce')}}" method="post">
