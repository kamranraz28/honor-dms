...
<form action="{{route('midmanagement.midmanagement.update')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
...
<form action="{{route('midmanagement.midmanagement.updatePassword')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
