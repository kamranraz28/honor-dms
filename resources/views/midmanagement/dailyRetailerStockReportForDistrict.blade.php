...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('midmanagement.dailyRetailerStockReportForDistrict.store') }} " autocomplete="off" enctype="multipart/form-data">
