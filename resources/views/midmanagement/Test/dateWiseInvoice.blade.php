  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('sales.dateWiseInvoice') }}">Date Wise Invoice</a></li>
      </ol>
    </section>
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('sales.dateWiseInvoice.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
