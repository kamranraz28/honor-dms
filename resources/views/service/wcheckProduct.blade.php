...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('service.wcheckProduct.store') }} " autocomplete="off" enctype="multipart/form-data">
...
<tr>
          ...
          <td> {{$wcheckProduct['brand']['name']}} </td>
           <td> {{$wcheckProduct['sno']}} </td>
          <td> {{$wcheckProduct['imei']}} </td>
         
          <td> {{$wcheckProduct['user']['firstname']}}</td>
          <td> {{$wcheckProduct['user']['officeid']}}</td>
          <td> {{$wcheckProduct['mobile']}} </td>
...
<form action="{{route('service.wcheckProduct.repalce')}}" method="post">
