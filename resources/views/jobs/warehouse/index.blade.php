...
<script>
    const jobDetailsBaseUrl = "{{ url('warehouse-panel/jobs') }}";
            ...
            jobs.forEach((job, index) => {
                ...
                const row = $(`
                    <tr class="job-row ${rowStatusClass}">
                        ...
                        <td>
                            <div class="cell-main">
                                <span class="job-order">${job.order_number || 'N/A'}</span>
                                <span class="job-subtext">Order ref</span>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <button class="btn-view-advanced" onclick="window.location.href='${jobDetailsBaseUrl}/${job.id}/details'">
                                <span class="btn-icon">
