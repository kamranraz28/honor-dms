  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('admin.product') }}">Add Product</a></li>
      </ol>
    </section>
...
{{-- for for displaying success and errror message --}}
  <form class="form-horizontal" method="POST" action="{{ route('admin.product.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
{{-- for for displaying success and errror message --}}
      ...
      <div class="col-md-12">
        <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
          ...
          <input type="number" id="price" name="price" class="form-control" placeholder="Enter Unit Price" value="{{ old('price') }}">
...
<form action="{{route('admin.product.update')}}" method="post" autocomplete="on" enctype="multipart/form-data">
...
<div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
  <label for="price">Unit Price:</label>
  <input type="number" id="price" name="price" class="form-control" placeholder="Enter Unit Price" value="{{ $element['price'] }}">
  <span class="text-danger">{{ $errors->first('price') }}</span>
</div>
