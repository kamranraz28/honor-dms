  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('admin.distributorStock') }}">Distributor Stock</a></li>
      </ol>
    </section>
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            ...
            <!-- form start -->
  <form class="form-horizontal" method="POST" action="{{ route('admin.distributorStock.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <div class="input-group date">
                      ...
                      <input name="fdate" placeholder="MM/DD/YYYY" type="text" class="form-control pull-right" id="datepicker" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-5">
                    <div class="input-group date">
                      ...
                      <input name="todate" placeholder="MM/DD/YYYY" type="text" class="form-control pull-right" id="datepicker1" autocomplete="off">
                    </div>
                  </div>
                </div>
...
<div class="form-group">
  ...
  <div class="col-md-10">
    <label class="checkbox-inline"><input type="checkbox" name="alldate" value="alldate">All Date Ways Reports</label>
  </div>
</div>
              <!-- /.form group -->
...
<!-- form start -->
      ...
      <div class="row">
            ...
            <div class="box-header">
              <h3 class="box-title">Distributor Stock List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <tr>
                  ...
                  <th colspan="5">Region : {{$region_name}} , Distributor : {{$distributor_name}} , Date: {{$to_date}} to {{$to_date}}</th>
...
@foreach ($data as $element)
  <tr>
    <td>{{$element['product']}}-{{$element['sku']}}</td>
    <td>{{$element['sku']}}</td>
