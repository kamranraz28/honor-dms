...
{{-- for for displaying success and errror message --}}
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label for="model" style="visibility: hidden;">IMEI 1:</label>
...
<td>
          <button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#{{'saleoutDeleteModal'. $wcheckProduct['id']}}"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
</td>
</tr>
...
<!-- body part -->
  ...
  <form action="{{route('admin.saleout.delete',$wcheckProduct['id'])}}" method="post">
...
<form action="{{route('admin.wcheckProduct.repalce')}}" method="post" enctype="multipart/form-data">
