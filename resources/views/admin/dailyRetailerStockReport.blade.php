...
@section('title', 'Sales Automation Process :: Retailer Stock Amount')
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title text-danger">
                            <i class="fa fa-database"></i> Retailer Daily Stock Amount
                        </h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="stats-section" style="margin-top: 24px;">
                            ...
                            <form action="{{ route('admin.dailyRetailerStockReport.store') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label" for="retailer_input">Retailer (Leave Blank for All
                                                )</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-user"></i></div>

                                                <input type="text" id="retailer_search" class="form-control"
                                                    placeholder="Type to search retailer..." list="retailer_list"
                                                    autocomplete="off">

                                                <datalist id="retailer_list"></datalist>

                                                <input type="hidden" name="retailer_id" id="retailer_id_hidden">
                                            </div>
                                        </div>
