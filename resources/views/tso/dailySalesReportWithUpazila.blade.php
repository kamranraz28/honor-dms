...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('tso.dailySalesReportWithUpazila.store') }} " autocomplete="off" enctype="multipart/form-data">
...
@foreach ($dailySalesReportWithUpazilas as $key => $element)
<tr>
          <td> {{$key + 1}} </td>
