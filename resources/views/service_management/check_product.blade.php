            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="box-title text-danger">Check Products</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <!-- form start -->
                        <form action="{{route('serviceManagement.checkReportStore')}}" method="post">
                            @csrf
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-warning">
                    <div class="box-header">
<a href="{{ route('serviceManagement.checkProductExcel', ['export' => 'excel']) }}" class="btn btn-success">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h2 class="modal-title" style="text-align: center; color: blue">
                                                            Approve Received Product</h2>
                                                    </div>
                                                    <form method="post"
                                                        action="{{route('serviceManagement.approveReceiveProduct', $receive['id'])}}">
                                                        @csrf
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <button type="submit"
                                                                        class="btn btn-success btn-block">Receive</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close"
                                                            data-dismiss="modal">&times;</button>
                                                        <h2 class="modal-title" style="text-align: center; color: blue">
                                                            Cancel Received Product</h2>
                                                    </div>
                                                    <form method="post"
                                                        action="{{route('serviceManagement.cancelProduct', $receive['id'])}}">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Void</label>
                                                                        <select id="dropdownField" name="void"
                                                                            class="form-control" required>
                                                                            <option value="" disabled selected>Select an
                                                                                option</option>
                                                                            <option value="Physical Demage">Physical Demage
                                                                            </option>
                                                                            <option value="liquid Demage">liquid Demage
                                                                            </option>
                                                                            <option value="Over Heat">Over Heat</option>
                                                                            <option value="Misuse by User">Misuse by User
                                                                            </option>
