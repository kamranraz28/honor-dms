            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="box-title text-danger">Approve Deliverd Products</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">

                    <form action="{{route('serviceManagement.approveDeliverReportStore')}}" method="post">
                            @csrf
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-warning">
                    <div class="box-header">
<a href="{{ route('serviceManagement.approveDeliverProductExcel', ['export' => 'excel']) }}" class="btn btn-success">
