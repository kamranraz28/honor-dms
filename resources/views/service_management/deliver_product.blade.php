            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="box-title text-danger">Deliver Products</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">

                    <form action="{{route('serviceManagement.deliverReportStore')}}" method="post">
                            @csrf
...
@endif
                ...
                <div class="box box-warning">
                    <div class="box-header">
<a href="{{ route('serviceManagement.deliverProductExcel', ['export' => 'excel']) }}" class="btn btn-success">
            ...
            View
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-info" data-toggle="modal"
                                                data-target="#myModal_{{$receive['id']}}">Approve</button>
                                                <button type="button" class="btn btn-sm btn-info" data-toggle="modal"
                                                data-target="#myModal2_{{$receive['id']}}">Cancel</button>
                                        </td>
                                        <td>{{ $receive['name'] }}</td>
                                        <td>{{ $receive['model'] }}</td>
                                        <td>{{ $receive['brand'] }}</td>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h2 class="modal-title" style="text-align: center; color: blue">Checking Product to Delivery</h2>
                                                    </div>
                                                    <form method="post"
                                                        action="{{route('serviceManagement.approveDelivery', $receive['id'])}}">
                                                        @csrf
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Replacing IMEI-1</label>
                                                                        <input type="text" class="form-control"
                                                                            name="imei" value="{{ $receive['replace1'] }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                        ...
                                        <div id="myModal2_{{$receive['id']}}" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close"
                                                            data-dismiss="modal">&times;</button>
                                                        <h2 class="modal-title" style="text-align: center; color: blue">Cancel Received Product</h2>
                                                    </div>
                                                    <form method="post"
                                                        action="{{route('serviceManagement.cancelDeliveryProduct', $receive['id'])}}">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Void</label>
                                                                        <select id="dropdownField" name ="void" class="form-control" required>
                                                                            <option value="" disabled selected>Select an option</option>
                                                                            <option value="Physical Demage">Physical Demage</option>
                                                                            <option value="liquid Demage">liquid Demage</option>
                                                                            <option value="Over Heat">Over Heat</option>
                                                                            <option value="Misuse by User">Misuse by User</option>
