            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="box-title text-danger">Canceled Products</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">

                    <form action="{{route('serviceManagement.cancelReportStore')}}" method="post">
                            @csrf
...
@endif
                ...
                <div class="box box-warning">
                    <div class="box-header">
<a href="{{ route('serviceManagement.canceledProductExcel', ['export' => 'excel']) }}" class="btn btn-success">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h2 class="modal-title" style="text-align: center; color: blue">Send to Receive Process</h2>
                                                    </div>
                                                    <form method="post"
                                                        action="{{route('serviceManagement.sendToReceive', $receive['id'])}}">
                                                        @csrf
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close"
                                                            data-dismiss="modal">&times;</button>
                                                        <h2 class="modal-title" style="text-align: center; color: blue">Send to Cancel Deliver Product</h2>
                                                    </div>
                                                    <form method="post"
                                                        action="{{route('serviceManagement.cancelDeliveryConfirm', $receive['id'])}}">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <button type="submit"
                                                                        class="btn btn-success btn-block">Confirm Cancel</button>
                                                                </div>
                                                            </div>
                                                        </div>
