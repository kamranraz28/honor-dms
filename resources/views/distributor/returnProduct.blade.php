...
{{-- for for displaying success and errror message --}}
  <form class="form-horizontal" method="POST" action="{{ route('distributor.returnProduct.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
<!-- body part -->
  ...
  <form action="{{route('distributor.returnProduct.delete',$element->id)}}" method="post">
