...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('distributor.dailyRtlStockReportV1.store') }} " autocomplete="off" enctype="multipart/form-data">
...
@endphp
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
<p style="text-align: center;font-size: 12px;font-weight: bold;color: black;">Retailer Stock Report From {{@$ssdata['fdate']}} to {{@$ssdata['todate']}}</p>
 <table id="example" class="display" cellspacing="0" width="100%">
            ...
            @endforeach
                ...
                <tbody>
@foreach ($dailyRtlStockReportV1s as $key1 => $element)
