  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <h3 class="box-title text-danger">Daily Retailer Stock Report</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('distributor.dailyRetailerStockReportForRetailer.store') }} " autocomplete="off" enctype="multipart/form-data">
...
{{-- for for displaying success and errror message --}}
               ...
               <br><br>
                  ...
                  <div class="col-md-12 {{ $errors->has('user_id') ? 'has-error' : '' }}">
                    <label for="retailer" class="control-label">Retailer</label>
                    <select name="user_id" id="user_id" class="form-control select2" style="width: 100%;" required="required">
