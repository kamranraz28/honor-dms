...
{{-- for for displaying success and errror message --}}
  <form class="form-horizontal" method="POST" action="{{ route('distributor.SRStore') }}" autocomplete="off" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
<form action="{{route('distributor.SRUpdate')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
...
<!-- body part -->
  ...
  <form action="{{route('distributor.SRDelete',$element->id)}}" method="post">
   <h3 class="text-info">Do You Want To Delete This SR?</h3>
   <br>
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
