...
@section('title')
  {{"Sales Automation Process :: Retailer Sales "}}
@endsection
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <h3 class="box-title text-danger">Retailer Sales Report</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('distributor.dailyCampaignReport.store') }} " autocomplete="off" enctype="multipart/form-data">
...
{{-- for for displaying success and errror message --}}
 ...
 <a style="float: left" target="_blank" class="btn btn-lg btn-success pull-right" href="{{route('distributor.stock.terexcel')}}">Saleout Report Export (ALL)</a>  
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
@endphp
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <!-- <a href="{{ route('distributor.dailyCampaignReport.print',[$user_id,$fdate,$todate]) }}" target="_blank" class="btn btn-info btn-xs pull-right">Print Report</a> -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
<p style="text-align: center;font-size: 12px;font-weight: bold;color: black;">Retailer Sales Report From {{$ssdata['fdate']}} to {{$ssdata['todate']}}</p>
