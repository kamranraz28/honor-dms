...
<form action="{{route('distributor.distributor.update')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
...
<div class="col-md-12">
  ...
  <div class="form-group {{ $errors->has('nidimage') ? 'has-error' : '' }}">
    <label for="nidimage">NID Image:</label>
    <input type="file" name="nidimage">
    <span class="text-danger">{{ $errors->first('nidimage') }}</span>
  </div>
...
<form action="{{route('distributor.distributor.updatePassword')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
...
<form action="{{route('distributor.distributor.updateAlternativeEmail')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
