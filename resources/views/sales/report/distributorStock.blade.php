                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <div class="input-group date">
                      ...
                      <input name="fdate" placeholder="DD/YYYY" type="text" class="form-control pull-right" id="datepicker"  required="required" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-5">
                    <div class="input-group date">
                      ...
                      <input name="todate" placeholder="DD/YYYY" type="text" class="form-control pull-right" id="datepicker1"  required="required" autocomplete="off">
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  $('#region').on('change', function(e){
    ...
    var route = "{{route('sales.territorySelectBoxOnRegionWithAjax')}}/"+region_id;
  ...
  $('#territory').on('change', function(e){
    ...
    var route = "{{route('sales.distributorSelectBoxOnTerritoryWithAjax')}}/"+territory_id;
    $.get(route, function(data) {
      console.log(data);
      $('#distributor').empty();
