  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('accounts.distributorInvoiceHistory') }}">Distributor Invoice History</a></li>
      </ol>
    </section>
...
<!-- form start -->
  <form class="form-horizontal" method="POST" action="{{ route('accounts.distributorInvoiceHistory.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
@foreach ($data as $element)
  ...
  <tr>
    ...
    <td><a href="{{ route('accounts.distributorInvoiceHistoryDetails',[$element['distributor_id']]) }}" class=" btn btn-success btn-md">View Details</a></td>
  </tr>
