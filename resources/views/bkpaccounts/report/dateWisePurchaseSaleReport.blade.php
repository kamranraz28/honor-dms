...
@section('title')
  {{"DMS :: Primary and Secondary Sales Report"}}
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('accounts.dateWisePurchaseSaleReport') }}">PS Report</a></li>
      </ol>
    </section>
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('accounts.dateWisePurchaseSaleReport.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
