  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('accounts.dateWisePrimarySale') }}">Date Wise Primary Sale</a></li>
      </ol>
    </section>
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Search Date Wise Primary Sale</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('accounts.dateWisePrimarySale.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
      ...
      <div class="row">
            ...
            <div class="box-body">
              <table id="example" class="display" cellspacing="0" width="100%">
                <thead>
                <tr>
                  <th colspan="11"> Date: {{$from_date}} to {{$to_date}}</th>
                </tr>
                <tr>
                ...
                <tbody>
@forelse ($purchaseproducts as $element)
  ...
  <td>
    ...
    <td>
      {{$element['product_qty'] * $element['product_price']}}
    </td>
