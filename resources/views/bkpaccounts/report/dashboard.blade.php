      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>{{round($invoiceResult->vat_amount + $invoiceResult->total), 2 }} TK</h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>{{round($invoiceResult->deposit), 2 }} TK</h3>

              <p>Total Deposite Value</p>
            </div>
            <div class="icon">
...
<td>
  @if ($element['purchase']['status'] == 2)
    <button  class=" btn btn-info btn-xs" data-toggle="modal" data-target="#{{'inputChalanModal'. $element['id']}}">Accept Chalan</button>
