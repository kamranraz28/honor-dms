...
@section('title')
  {{"DMS :: Factory Finished Good History"}}
@endsection
...
<!-- content part================================ -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Factory Finished Good History
        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ route('accounts.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"></i> REPORTS</a></li>
        <li class="active"><a href="{{ route('accounts.factoryFinishedGoodHistoryDetails') }}">Finished Goods Details History</a></li>
      </ol>
    </section>
