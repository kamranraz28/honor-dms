  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('accounts.preturnproduct') }}">Return Products</a></li>
      </ol>
    </section>
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('accounts.preturnproduct.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
<form action="{{route('accounts.preturnproduct.update')}}" method="post">
...
<!-- body part -->
  ...
  <form action="{{route('accounts.preturnproduct.delete',$element['id'])}}" method="post">
