  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('accounts.distributorStock') }}">Distributor Stock</a></li>
      </ol>
    </section>
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            ...
            <!-- form start -->
  <form class="form-horizontal" method="POST" action="{{ route('accounts.distributorStock.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
            ...
            <div class="box-body">
              ...
              <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <tr>
                  ...
                  <th colspan="5">Distributor : {{$distributor_name}} , Date: {{$to_date}} to {{$to_date}}</th>
