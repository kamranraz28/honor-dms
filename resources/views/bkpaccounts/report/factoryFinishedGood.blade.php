  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('accounts.factoryFinishedGood.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
@foreach ($data as $element)
  ...
  <tr>
    ...
    <td><a href="{{ route('accounts.factoryFinishedGoodHistoryDetails',[$element['product_id']]) }}" class=" btn btn-success btn-md">View Details</a></td>
  </tr>
@endforeach
