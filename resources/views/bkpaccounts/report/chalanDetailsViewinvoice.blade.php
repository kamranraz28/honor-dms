...
<!-- content part================================ -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ route('factory.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"></i> ASO</a></li>
        <li class="active"><a href="{{ route('factory.chalanDetails') }}">Chalan Details</a></li>
      </ol> -->
    </section>
...
<h4 style="font-weight: bolder;">Delivery Invoice</h4>
          ...
          <b>VAT Chalan NO : </b> {{$chalan['chalan_no']}}<br>
          <b>VAT Chalan Date : </b> {{$chalan['chalan_date']}}<br>
        </div>
        <!-- /.col -->
      </div>
      <!-- /.row -->
...
//=============================================
  ...
  <tr>
    ...
    <td>{{number_format($element['product_price'],2)}}</td>
