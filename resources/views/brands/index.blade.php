...
@section('title')
  {{"Sales Automation Process :: Brand OR Company"}}
@endsection
...
{{-- for for displaying success and errror message --}}
  <form class="form-horizontal" method="POST" action="{{ route('brands.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
<form action="{{route('brands.update',$element['id'])}}" method="post">
...
<!-- body part -->
  ...
  <form action="{{route('brands.destroy',$element['id'])}}" method="post">
