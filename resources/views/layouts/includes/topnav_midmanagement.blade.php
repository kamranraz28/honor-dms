<header class="main-header">
    <!-- Logo -->
    <a href="{{ route('midmanagement.dashboard') }}" class="logo">
...
@endif
                ...
                <p>
                  {{Auth::user()->firstname}} {{Auth::user()->lastname}} - Mid Management
...
@endif
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="{{ route('midmanagement.dashboard') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('midmanagement.midmanagement') }}"><i class="fa fa-circle-o text-aqua"></i>Profile</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!-- <li><a href="{{ route('midmanagement.dailySalesReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Sales Report</a></li>
                    
            <li><a href="{{ route('midmanagement.dailyCampaignReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Campaign Report</a></li> -->


            <li><a href="{{ route('midmanagement.dailyRetailerStockReportForDistrict') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Retailer Stock</a></li>



            <li><a href="{{ route('midmanagement.dailySalesReportWithDistrict') }}"><i class="fa fa-circle-o text-aqua"></i>Sales Report Per District</a></li>
            
            <li><a href="{{ route('midmanagement.dailyCampaignReportWithDistrict') }}"><i class="fa fa-circle-o text-aqua"></i>Campaign Report Per District</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('midmanagement.wcheckProduct') }}"><i class="fa fa-circle-o text-aqua"></i>Warranty Check</a></li>
          </ul>
        </li>
