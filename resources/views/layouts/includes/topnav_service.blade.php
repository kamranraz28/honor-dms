<header class="main-header">
    <!-- Logo -->
    <a href="{{ route('service.dashboard') }}" class="logo">
...
@endif
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        {{-- <li><a href="{{ route('service.dashboard') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li> --}}
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('service.wcheckProduct') }}"><i class="fa fa-circle-o text-aqua"></i>Warranty Check</a></li>
          </ul>
        </li>
