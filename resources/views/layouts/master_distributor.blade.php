...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <!-- top nav part================================ -->
        @include('layouts.includes.topnav_distributor')
        <!-- top nav part================================ -->
    ...
    <script src="{{ asset('resources/assets/dms/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}">
    </script>
    <!-- date-range-picker -->
    <script
        src="{{ asset('resources/assets/dms/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}">
    </script>
    <!-- SlimScroll -->
