...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('huawei.dailyCampaignReportWithDistrict.store') }} " autocomplete="off" enctype="multipart/form-data">
...
@foreach ($dailyCampaignReportWithDistrictss as $key => $element)
<tr>
          <td> {{$key + 1}} </td>
...
console.log(district_id);
    ...
    $.get(route, function(data) {
      ...
      $.each(data, function(index,data){
        $('#user_id').append('<option value="' + data.id + '">' + data.firstname + " "+ data.lastname + " ( " + data.officeid +" ) " +  '</option>');
      });
    });
