...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('huawei.dailyCampaignReport.store') }} " autocomplete="off" enctype="multipart/form-data">
...
{{-- for for displaying success and errror message --}}
               ...
               <br><br>
                  ...
                  <div class="col-md-4 {{ $errors->has('brand_id') ? 'has-error' : '' }}">
                    ...
                    <select name="brand_id" id="brand_id" class="form-control" style="width: 100%;" required="required">
...
@endphp
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <!-- <a href="" target="_blank" class="btn btn-info btn-xs pull-right">Print Report</a> -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
