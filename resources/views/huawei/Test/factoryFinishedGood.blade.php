  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('sales.factoryFinishedGood') }}">Factory Stock</a></li>
      </ol>
    </section>
    ...
    <section class="content-header">
      ...
      <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('sales.factoryFinishedGood.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
@foreach ($data as $element)
  ...
  <tr>
    ...
    <td><a href="{{ route('sales.factoryFinishedGoodHistoryDetails',[$element['product_id']]) }}" class=" btn btn-success btn-md">View Details</a></td>
  </tr>
@endforeach
