...
<form action="{{route('huawei.huawei.update')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
...
<form action="{{route('huawei.huawei.updatePassword')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
