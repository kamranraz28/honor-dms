...
<div class="content-wrapper">
            ...
            <div class="row new-box">
                ...
                <div class="card card-default">
                    <div class="card">
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" action="{{ route('orderspostings.update', $ordersposting->id) }} " id="blah"
    ...
    <input type="hidden"
           name="orader_number"
           value="{{ $ordersposting->orader_number }}"
           class="form-control{{ $errors->has('orader_number') ? ' is-invalid' : '' }}"
           placeholder="Order Number">
    @if($errors->has('orader_number'))
        <div class="invalid-feedback">{{ $errors->first('orader_number') }}</div>
    @endif
</div>
        ...
        <input type="checkbox" class="toggleDiscount"> Discount
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="totalQuantity" id="totalQuantity" class="form-control" readonly />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="box-footer mt20">
                                    <button type="submit" class="btn btn-success btn-lg" id="blahButton" onclick="disableAndChange()">
...
@push('scripts')
<script>
    function disableAndChange() {
        var submitButton = document.getElementById('blahButton');
...
function updateTotalPrice() {
    ...
    $('.final_total').each(function(index, element) {
        ...
        $(element).val(finalTotal.toFixed(2));
