...
<form action="{{route('retailer.retailer.update')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
...
<form action="{{route('retailer.retailer.updatePassword')}}" method="post"  autocomplete="on" enctype="multipart/form-data">
