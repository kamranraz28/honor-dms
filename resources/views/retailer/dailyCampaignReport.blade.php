...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal" method="POST" action="{{ route('retailer.dailyCampaignReport.store') }} " autocomplete="off" enctype="multipart/form-data">
...
@endphp
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <!-- <a href="{{ route('retailer.dailyCampaignReport.print',[$user_id,$fdate,$todate]) }}" target="_blank" class="btn btn-info btn-xs pull-right">Print Report</a> -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
