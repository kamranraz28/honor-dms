...
<!-- ==============one section area ================= -->
  ...
  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
             <form class="form-horizontal1" method="POST" action="{{ route('retailer.wcheckProduct.store') }} " autocomplete="off" enctype="multipart/form-data">
...
<form action="{{route('retailer.wcheckProduct.repalce')}}" method="post">
...
<div class="form-group {{ $errors->has('sno') ? 'has-error' : '' }}">
  ...
  <input type="text" id="sno" name="sno" class="form-control" placeholder="Enter IMEI 1" value="{{ old('sno') }}" required="required">
  <span class="text-danger">{{ $errors->first('sno') }}</span>
</div>

<div class="form-group {{ $errors->has('imei') ? 'has-error' : '' }}">
  <label for="imei">IMEI 2 :</label>
  <input type="text" id="imei" name="imei" class="form-control" placeholder="Enter IMEI 2 " value="{{ old('imei') }}">
  <span class="text-danger">{{ $errors->first('imei') }}</span>
</div>
...
<form action="{{route('retailer.wcheckProduct.service')}}" method="post">
...
<!-- body part -->
  ...
  <form action="{{route('retailer.wcheckProduct.repalce.update',$replace['id'])}}" method="post">
...
<!-- body part -->
  ...
  <form action="{{route('retailer.wcheckProduct.repalce.delete',$replace['id'])}}" method="post">
