...
@section('title', 'Sales Automation Process :: Primary Transfer Report')
            ...
            <div class="box box-warning">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title text-danger">
                        <i class="fa fa-database"></i> Primary Transfer Report
                    </h3>
                </div>
                    ...
                    <div class="stats-section" style="margin-top: 24px;">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form action="{{ route('admin.primaryTransferReport.store') }}"
                                      method="POST"
