...
@section('title', 'Sales Automation Process :: Stock Report')
            ...
            <div class="box box-warning">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title text-danger">
                        <i class="fa fa-database"></i> IMEI Stock Report
                    </h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="stats-section">
                        ...
                        <div class="admin-action-row">
                            <a target="_blank"
                               href="{{ route('admin.currentMonthReceiveReport') }}"
                    ...
                    <div class="stats-section" style="margin-top: 24px;">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form action="{{ route('admin.allReceiveReport') }}"
                                      method="POST"
