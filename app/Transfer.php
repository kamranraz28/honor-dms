...
class Transfer extends Model
{
  ...
  protected $fillable = ['user_id','ruser_id','retailer_id','new_retailer_id','sr_id','stock_id','imei','product_id','brand_id','sno','status','sale_date'];
  ...
  public function newRetailer() {
    return $this->belongsTo('\App\User', 'new_retailer_id')->select('id', 'firstname', 'email', 'officeid');
}
